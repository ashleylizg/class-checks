...
plt.plot(x_values, key_limes_per_month, color= 'DarkGreen')
plt.plot(x_values, persian_limes_per_month, color='GreenYellow')
plt.plot(x_values, blood_limes_per_month, color='LightCoral')
...
plt.title("Sales of Lime Varieties per Month")
plt.subplots_adjust(hspace=0.4, bottom=0.3)
plt.show()
plt.savefig("Sublime Limes' Sales over Time.png")
